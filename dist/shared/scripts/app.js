...
},{"fsovz6":2}],6:[function(require,module,exports){
"use strict";
var config = {
  instrument: false
};
...
$.fn.imagesLoaded = function() {
  var deferreds;
  deferreds = $.map(this, function(el, i) {
    var d, img;
    d = new $.Deferred;
    img = new Image();
    if (__indexOf.call(el, "onreadystatechange") >= 0) {
...
},{"backbone":1,"es6-promise":3,"jquery":13,"underscore":14}]},{},[15])